...
| [Device Info]          | ✅     | ✅        | Get information about the HSM like software versions and algorithms |
...
| [Generate Asymmetric]  | ✅     | ✅        | Randomly generate a new asymmetric key within the HSM |
| [Generate HMAC Key]    | ⛔     | ⛔        | Randomly generate an HMAC key in the HSM |
| [Generate OTP Key]     | ⛔     | ⛔        | Randomly generate an AES key for Yubico OTP authentication |
...
| [Put Authkey]          | ✅     | ⛔        | Put an AES-128 preshared authentication key into the HSM |
